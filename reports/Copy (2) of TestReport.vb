...
Public Class Copy_2_of_TestReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copy (2) of TestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.Copy (2) of TestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_2_of_TestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_2_of_TestReport = New Copy_2_of_TestReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
