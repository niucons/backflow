...
Public Class TestReport_053009
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.TestReport-053009.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestReport_053009
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestReport_053009 = New TestReport_053009()
        rpt.Site = Me.Site
        Return rpt
    End Function
