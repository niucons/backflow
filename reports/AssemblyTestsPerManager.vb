...
Public Class AssemblyTestsPerManager
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AssemblyTestsPerManager.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.AssemblyTestsPerManager.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAssemblyTestsPerManager
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AssemblyTestsPerManager = New AssemblyTestsPerManager()
        rpt.Site = Me.Site
        Return rpt
    End Function
