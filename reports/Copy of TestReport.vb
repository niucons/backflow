...
Public Class Copy_of_TestReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.Copy of TestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopy_of_TestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copy_of_TestReport = New Copy_of_TestReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
