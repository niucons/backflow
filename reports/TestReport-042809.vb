...
Public Class TestReport_042809
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.TestReport-042809.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestReport_042809
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestReport_042809 = New TestReport_042809()
        rpt.Site = Me.Site
        Return rpt
    End Function
