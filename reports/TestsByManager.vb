...
Public Class TestsByManager
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.TestsByManager.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestsByManager
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestsByManager = New TestsByManager()
        rpt.Site = Me.Site
        Return rpt
    End Function
