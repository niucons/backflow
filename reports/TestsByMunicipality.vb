...
Public Class TestsByMunicipality
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TestsByMunicipality.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bftm.TestsByMunicipality.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestsByMunicipality
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestsByMunicipality = New TestsByMunicipality()
        rpt.Site = Me.Site
        Return rpt
    End Function
